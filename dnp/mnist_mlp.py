...
from dnp.models.rff_mlp import MLP, View
        ...
        logger.store_metrics(
            {
                ...
                "train/accuracy": accuracy / len(target),
            }
        )
...
class Params(ParamsProto):
    ...
    lr: float = Proto(0.001, metavar="LR", help="learning rate (default: 1.0)")
...
def main(charts=None, **deps):
    ...
    preproc = View(784)
    model = MLP(784, 400, 5, 10, preproc=preproc).to(Params.device)
